...
namespace kalista
{
    ...
    void load()
    {
        ...
        q->set_skillshot(0.25f, 40.0f, 2400.0f, { collisionable_objects::yasuo_wall, collisionable_objects::heroes, collisionable_objects::minions }, skillshot_type::skillshot_line);
